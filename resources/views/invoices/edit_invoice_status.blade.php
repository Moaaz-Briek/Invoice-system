...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <a class="content-title mb-0 my-auto" href="{{url('invoices')}}" >الفواتير</a><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    تعديل فاتورة</span>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{url('Status-Update')}}/{{$invoices->id}}" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                                       type="text" readonly value="{{ $invoices->invoice_Date }}" required>
                            </div>

                            <div class="col">
                                <label>تاريخ الاستحقاق</label>
                                <input class="form-control fc-datepicker" name="Due_date" placeholder="YYYY-MM-DD"
                                       type="text" readonly value="{{ $invoices->Due_date }}" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" readonly class="form-control SlectBox" onclick="console.log($(this).val())"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" readonly class="form-control form-control-lg" id="Discount" name="Discount"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" readonly class="control-label">الاجمالي شامل الضريبة</label>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" readonly id="exampleTextarea" name="note" rows="3">
