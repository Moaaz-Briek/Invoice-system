...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<a class="content-title mb-0 my-auto" href="{{url('invoices')}}"><h4>الفواتير</h4></a><span class="text-muted mt-1 tx-13 mr-2 mb-0">/الفواتير المدفوعة جزئياُ</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                        ...
                        <div class="card mg-b-20">
                            <div class="card-header pb-0">
                                <div class="d-flex justify-content-between">
                                    <a class="modal-effect btn btn-primary btn-block btn-lg" href="invoices/create">إضافة فاتورة</a>
                                </div>
                            </div>
                            <div class="card-body">
