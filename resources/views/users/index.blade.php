...
@section('css')
    ...
    @section('title')
        المستخدمين - MSMB للادارة الفواتير
    @stop
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="col-sm-1 col-md-2">
                        @can('اضافة مستخدم')
                            <a class="btn btn-primary btn-سة" href="{{ route('users.create') }}">إضافة مستخدم</a>
                        @endcan
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="label text-danger">
                                                <div class="dot-label bg-danger ml-1" style="margin-right: 70px"></div>{{ $user->status }}
                                            </span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @endcan
                                                ...
                                                <a href="{{ route('users.show', $user->id) }}" class="btn btn-sm btn-info"
                                                   title="إظهار"><i class="las la-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
