                        ...
                        <div class="card mg-b-20">
                            <div class="card-header pb-0">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a class="modal-effect btn btn-primary btn-block btn-lg" data-effect="effect-scale" data-toggle="modal" href="#modaldemo2">إضافة منتج</a>
                                </div>
                                @endcan
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example1" class="table key-buttons text-md-nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('تعديل منتج')
                                                <a class="modal-effect btn btn-info btn-sm" style="margin-left: 10px" data-effect="effect-scale"
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('products.store') }}" method="post">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button  type="button" class="btn ripple btn-secondary" data-dismiss="modal">إغلاق</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-content modal-content-demo">
                                ...
                                <form action="products/destroy" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input class="form-control" name="product_name" id="product_name" value="product_name" type="text" readonly>
                                    </div>
                                    <div class="modal-footer">
