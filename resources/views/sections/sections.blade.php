                    ...
                    <div class="card mg-b-20">
                        ...
                        @can('اضافة قسم')
                            <div class="d-flex justify-content-between">
                                <a class="modal-effect btn btn-primary btn-block btn-lg" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">إضافة قسم</a>
                            </div>
                        @endcan
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example1" class="table key-buttons text-md-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">مُنشأ القسم</th>
                            ...
                            <div class="modal-body">
                                <form action="{{ route('sections.store') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="section_name" required name="section_name">
                                    </div>
