                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                                ...
                                <select class="form-control select2" name="type" required>
                                    @isset($type)
                                        @if($type == 'مدفوعة')
                                            <option value="مدفوعة" selected>الفواتير المدفوعة</option>
                                            <option value="غير مدفوعة">الفواتير الغير مدفوعة</option>
                                            <option value="مدفوعة جزئيا">الفواتير المدفوعة جزئيا</option>
                                        @elseif($type == 'غير مدفوعة')
                                            <option value="غير مدفوعة" selected>الفواتير الغير مدفوعة</option>
                                        ...
                                        @endif
                                    @else
                                        <option disabled selected>حدد نوع الفاتورة</option>
                                        <option value="مدفوعة">الفواتير المدفوعة</option>
                                        <option value="غير مدفوعة">الفواتير الغير مدفوعة</option>
                                        <option value="مدفوعة جزئيا">الفواتير المدفوعة جزئيا</option>
                                    @endif
